...
% Main
    ...
    % Выбор имени файла-записи
        % Директория с файлами-записями
            Main.SigDirName = '/home/s/Prjcts/Matlab/Git/GPS-MATLAB-6-Course/Signals';
        % Имя файла-записи
            Main.SigFileName = '04_03_2022__17_40_44_2.046_Mhz. 1 ch_1ch_15b_63000ms.dat';
...
% P70_GetRXPoses
    ...
    % [1, 2, 5, 7] - конкретные номера.
        P70_GetRXPoses.SatNums2Pos = 'all';%[1 2 3 4 5 6 7 8 9]; %;'first5';
