% РџРѕСЃС‚СЂРѕРµРЅРёРµ РєСЂРёРІС‹С… РІРµСЂРѕСЏС‚РЅРѕСЃС‚Рё РїСЂР°РІРёР»СЊРЅРѕРіРѕ РѕР±РЅР°СЂСѓР¶РµРЅРёСЏ РІ Р·Р°РІРёСЃРёРјРѕСЃС‚Рё РѕС‚
% РћРЎРЁ
tic
% profile on;
expNum = 1e4;
...
% f.YScale = 'log';
grid on;
title("Р’РµСЂРѕСЏС‚РЅРѕСЃС‚СЊ РїСЂР°РІРёР»СЊРЅРѕРіРѕ РѕР±РЅР°СЂСѓР¶РµРЅРёСЏ");
hold on;
xlabel('E_b/N_0, dB')
